                ...
                <Row className={`${styles.row__details}`}>
                        ...
                        <div className={`${styles.route}`}>
                            ...
                            <div className={`${styles.route__details}`}>
                                ...
                                <div>
                                    ...
                                    <p className={`${styles.color}`}>PAID - Approved</p>
                                </div>
                            </div>
                        </div>
                    </Col>
                    <Col xxl='8'>
                        <div className={`${styles.cargo}`}>
                            <p className={`${styles.cargo__para}`}>Cargo details </p>
                            <p className={`${styles.cargo__status}`}>PAID - APPROVED</p>
                        </div>
                        ...
                        <div className={`${styles.view__btn}`}>
                            <Link className={`${styles.view__link}`} to={`/shipment-details/${row.original.id}`}>View More</Link>
                        </div>
                    </Col>
                </Row>

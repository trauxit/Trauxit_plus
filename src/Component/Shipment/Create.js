...
const Create = () => {
    ...
    function finalize(e) {
        e.preventDefault();
        const reqData = {
            typeLoads: "Construction Materials",
            nameLoads: "Lumber",
            Weight: 1000,
            description: "Handle with care. Heavy items.",
            PickupLocation: {
                type: "Point",
                coordinates: [-118.3917, 34.0328],
                address: formData.pickup,
                description: "Construction Supplier"
            },
            DropoutLocation: {
                type: "Point",
                coordinates: [-118.2474, 33.9817],
        ...
        axios
            .post('http://35.181.26.123:3000/api/v1/loads/shipper/', reqData, {
                headers: {
        ...
        <>
            ...
            <section className={`${styles.home}`}>
                ...
                <div className={`${styles.homeContainer}`}>
                    <Form className={`${styles.groupline}`} onSubmit={(e) => finalize(e)}>
                        ...
                        <div>
                            ...
                            <button type='submit' className={`${styles.collect}`}>{t("Finish and Create")}</button>
                        </div>
                    </Form>
                </div>
                <ToastContainer />

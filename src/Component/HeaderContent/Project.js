        ...
        <>
            ...
            <section className={`${styles.home}`}>
                ...
                <div className={`${styles.homeContainer}`}>
                    <h3 className={`${styles.plus__title}`}>{t("Projects")}</h3>
                    ...
                    <div className={`${styles.project__option}`}>
                        <p className={`${active === 'open' ? styles.avtive__para : styles.not}`} onClick={() => setActive('open')}>{t("Open Projects")}</p>
                        <p className={`${active === 'work' ? styles.avtive__para : styles.not}`} onClick={() => setActive('work')}>{t("Work in Progress")}</p>
                        <p className={`${active === 'past' ? styles.avtive__para : styles.not}`} onClick={() => setActive('past')}>{t("Past Projects")}</p>
                    </div>
